...
[_QWERTY] = LAYOUT(
  ...
  KC_CAPS,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, BR_SCLN,  SC_RSPC,
  SC_LSPO,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_MPLY,KC_N,    KC_M, KC_COMM,  KC_DOT, BR_SLSH,  KC_INS,
...
[_SYMBOLS] = LAYOUT(
  ...
  KC_TRNS, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                       BR_CIRC, KC_AMPR, KC_UP, KC_LPRN, BR_TILD, SC_RSPC,
  KC_TRNS,  KC_EQL, KC_MINS, BR_CCED, BR_LBRC, BR_RBRC, KC_TRNS,       KC_TRNS, BR_ACUT, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NUBS, KC_PSCR,
